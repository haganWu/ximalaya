...
let Icongerenzhanghaoguanli: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Icongerenzhanghaoguanli.defaultProps = {
  size: 18,
};

Icongerenzhanghaoguanli = React.memo ? React.memo(Icongerenzhanghaoguanli) : Icongerenzhanghaoguanli;

export default Icongerenzhanghaoguanli;
